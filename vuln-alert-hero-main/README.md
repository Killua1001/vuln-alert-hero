...
## Como usar
1. `/auth` — crie uma conta.
2. Dashboard → **Sync KEV** (popula 1500+ vulnerabilidades exploradas).
3. Filtre, abra um CVE, gere resumo IA, simule pentest e exporte PDF.
4. Watchlist → monitore pacotes (npm/PyPI/etc) via OSV.dev.
